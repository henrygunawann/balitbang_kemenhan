...
<head>
    ...
    <link href="<?php echo base_url('assets/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/node_modules/datatables.net-bs4/css/responsive.dataTables.min.css');?>" rel="stylesheet">
</head>
...
<body class="horizontal-nav skin-megna fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Wasgarapps Sub Pusstrahan</p>
        </div>
    </div>
    <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <div class="box-body">
                                    <a href="<?php echo base_url(); ?>subsatker/galeriadd" class="btn btn-block btn-primary" style="width:150px;height:100">Add Gallery Wisata</a>
                                    <br><br>
                                    <table class="table table-bordered table-striped" id="myTable">      
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                foreach ($fotokegiatan as $g) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo character_limiter($g['satker_id'], 40) ?></td>
                                                    <td><?php echo character_limiter($g['fotokegiatan_judul '], 40) ?></td>
                                                    <td><?php echo character_limiter($g['fotokegiatan_keterangan'], 40) ?></td>
                                                    <td><?php echo character_limiter($g['fotokegiatan_tanggal'], 40) ?></td>
                                                    <td> <a href="<?=site_url(); ?>file/kegiatan/<?php echo $g['image'] ?>" target="_blank"><span class="label label-success">Lihat Gambar</span></a></td>
                                                    <td><?php echo $g['kategori']; ?></td>
                                                    <td align="center"><a href="<?=site_url('subsatker/galeriedit')?>/<?=$g['id']?>"><i class="fa fa-edit"></i> | 
                                                    </td>
                                                </tr>
                                                <?php
                                                }
    ...
    <script src="<?php echo base_url(); ?>assets/node_modules/datatables.net-bs4/js/dataTables.bootstrap4.min"></script>
