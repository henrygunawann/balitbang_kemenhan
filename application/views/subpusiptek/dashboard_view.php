                    ...
                    <div class="user-pro-body">
                        <div>
                            <img src="../assets/images/users/2.jpg" alt="user-img" class="img-circle">
                                                    ...
                                                    <a href="javascript:void(0)" class="u-dropdown link hide-menu" role="button" aria-haspopup="true" aria-expanded="false"><?php ($this->session->userdata('level')==='11');?><?php echo $this->session->userdata('username');?>
                            </a>
                    </div>
                </div>
                <!-- Sidebar navigation-->
                    ...
                    <ul id="sidebarnav">
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li>
                                    <a href="index.html">Detail Kegiatan </a>
                                </li>
                                <li>
                                    <a href="index2.html">Detail Anggota</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <h4 class="counter text-purple">Rp 207097841568</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
