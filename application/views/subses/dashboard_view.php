                    ...
                    <div class="user-pro-body">
                        <div>
                            <img src="../assets/images/users/2.jpg" alt="user-img" class="img-circle">
                                                    ...
                                                    <a href="javascript:void(0)" class="u-dropdown link hide-menu" role="button" aria-haspopup="true" aria-expanded="false"><?php ($this->session->userdata('level')==='13');?><?php echo $this->session->userdata('username');?>
                            </a>
                    </div>
                </div>
                <!-- Sidebar navigation-->
