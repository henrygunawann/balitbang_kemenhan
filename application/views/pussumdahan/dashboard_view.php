...
<body class="horizontal-nav skin-megna fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Wasgar Apps Pussumdahan</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <font color="white" align="center">Jl. Jati Raya Tim. No.1, RT.6/RW.6, Pd. Labu, Kec. Cilandak, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12450</font>
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="hidden-md-down"><?php ($this->session->userdata('level')==='7');?><?php echo $this->session->userdata('username');?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
